...
pub struct SecretsUpdateRequestChangeRequestsInner {
    ...
    pub value_type: Option<models::SecretsUpdateRequestChangeRequestsInnerValueType>,
    #[serde(rename = "originalValueType", skip_serializing_if = "Option::is_none")]
    pub original_value_type: Option<models::SecretsUpdateRequestChangeRequestsInnerOriginalValueType>,
}

impl SecretsUpdateRequestChangeRequestsInner {
    pub fn new(name: String, original_name: String, value: String) -> SecretsUpdateRequestChangeRequestsInner {
