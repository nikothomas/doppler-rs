...
/// ChangeRequestPoliciesUpdateRequestTargets : Describes the which projects, environments, and configs the policy applies to.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChangeRequestPoliciesUpdateRequestTargets {
...
impl ChangeRequestPoliciesUpdateRequestTargets {
    /// Describes the which projects, environments, and configs the policy applies to.
    pub fn new() -> ChangeRequestPoliciesUpdateRequestTargets {
