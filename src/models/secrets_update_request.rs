...
pub struct SecretsUpdateRequest {
    ...
    pub secrets: Option<models::SecretsUpdateRequestSecrets>,
    ...
    pub change_requests: Option<Vec<models::SecretsUpdateRequestChangeRequestsInner>>,
}

impl SecretsUpdateRequest {
    pub fn new(project: String, config: String) -> SecretsUpdateRequest {
