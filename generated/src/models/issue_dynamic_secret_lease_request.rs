...
pub struct IssueDynamicSecretLeaseRequest {
...
impl IssueDynamicSecretLeaseRequest {
    pub fn new(project: String , config: String , dynamic_secret: String , ttl_sec: i32 ) -> IssueDynamicSecretLeaseRequest {
        IssueDynamicSecretLeaseRequest {
            project: project,
            config: config,
