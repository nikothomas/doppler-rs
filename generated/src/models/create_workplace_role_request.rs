...
/// CreateWorkplaceRoleRequest
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateWorkplaceRoleRequest {
...
impl CreateWorkplaceRoleRequest {
    pub fn new(name: String , permissions: Vec<String> ) -> CreateWorkplaceRoleRequest {
        CreateWorkplaceRoleRequest {
            name: name,
